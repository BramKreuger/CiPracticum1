    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            for (int i = 0; i < 10; i++)
            {
                ...
                timer.Reset();
                timer.Start();
                Sudoku s = new Sudoku(true, 500, 1000, 50, 15, i);
                Console.WriteLine("Resultaat van sudoku: " + i + " is: " + s.simplythebest);
                timer.Stop();
                long elapsedTicks = timer.Elapsed.Ticks;
                Console.WriteLine(TimeSpan.FromTicks(elapsedTicks).ToString());
            }*/
            ...
            int[] rand_re = new int[] { 1000};//, 200, 500 };
            int[] hillclimbs = new int[] { 1000 };//, 100, 500 }; 500 is een beetje weinig ondergrens 500 10.000
            int[] no_improv = new int[] { 25, 50, 75 };//, 250 }; rond de 50 houden, 250 kan wel
            int[] rand_swap = new int[] { 5, 9, 11, 12, 15, 17 };//, 15 }; // 5 t/m 20
